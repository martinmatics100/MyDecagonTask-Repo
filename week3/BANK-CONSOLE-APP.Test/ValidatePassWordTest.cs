...
namespace BANK_CONSOLE_APP.Test
{
        ...
        public class ValidatePasswordTests
        {
            ...
            //[Test]
            //public void ValidPasswordCollector_InvalidInput_InvalidPassword_ContinuesLoop()
            //{
            //    // Arrange
            //    var validatePassword = new ValidatePassWord();
            //    stringReader = new StringReader("invali");
            //    Console.SetIn(stringReader);
            ...
            //    // Assert
            //    Assert.AreNotEqual("invalid", password);
            //    //Assert.IsTrue(stringWriter.ToString().Contains("Invalid password"));
            //}
